...
public class ImageUtil {
    ...
    public static BufferedImage mergeImage(boolean isHorizontal, BufferedImage img1, BufferedImage img2)
        ...
        if (isHorizontal) { // 水平方向合并
            ...
            DestImage.setRGB(0, 0, w2, h1, ImageArrayOne, 0, w1); // 设置上半部分或左半部分的RGB
    ...
    public static void main(String[] args) {
        ...
        try {
            bi1 = getBufferedImage("C:\\Users\\mis\\Desktop\\ph\\b.png");
            bi2 = getBufferedImage("C:\\Users\\mis\\Desktop\\ph\\a.png");
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        // 保存图像
        saveImage(destImg, "C:\\Users\\mis\\Desktop\\ph\\", "allv.png", "png");
        ...
        // 保存图像
        saveImage(destImg, "C:\\Users\\mis\\Desktop\\ph\\", "allh.png", "png");
