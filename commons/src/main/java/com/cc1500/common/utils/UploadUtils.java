...
import com.cc1500.common.utils.platform.OperationSystem;
...
public class UploadUtils {
    public static String uploadFile(MultipartFile file,String templateFileName) throws IOException{
        ...
        if (OperationSystem.isLinux()) {
            path = "home"+System.getProperty("file.separator")+"cc1500"+System.getProperty("file.separator")+"ibmsMusic"+System.getProperty("file.separator")+templateFileName;
        ...
        if (OperationSystem.isLinux()) {
            String tmpFile = "/usr/local/yealink/data/version-manager/work/Tomcat/localhost/ROOT/home/cc1500/ibmsmusic/musicfile/" + fileName;
