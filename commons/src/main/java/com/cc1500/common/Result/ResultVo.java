...
import com.cc1500.common.utils.SimplePropertyPreFilter;
...
public class ResultVo {
    ...
    public static String successful(String msg){
        return  SimplePropertyPreFilter.excludeJson(new ResultVo(msg,200));
    }

    public static String successful(String msg,Object data){
        return  SimplePropertyPreFilter.excludeJson(new ResultVo(msg,200,data));
    }
    ...
    public static String successful(){
        return  SimplePropertyPreFilter.excludeJson(new ResultVo("请求成功",200));
    }

    public static String successful(Object data){
        return  SimplePropertyPreFilter.excludeJson(new ResultVo("请求成功",200,data));
    }
    public static String failure(Object data){
        return  SimplePropertyPreFilter.excludeJson(new ResultVo("请求失败",200,data));
    }
