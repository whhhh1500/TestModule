...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static final String getNowTime() {
        return dateTimeNow(HHmm);
    }

    public static final String getNowTimeBymm() {
     ...
     * @return
     */
    public static String dateTimeBeforeThreeMinute(String time) throws ParseException {
        Calendar c = Calendar.getInstance();
        c.setTime(new Date(formatStringToTime(time)));
        c.add(Calendar.MINUTE, -30);
        return parseDateToStr(HHmm, c.getTime());
    }
     ...
     * @throws Exception 时间转化异常
     */
    public static String LongToStringTimeByAll(Long time) throws ParseException {
     ...
     * @return:
     */
    public static Date parseDate1(String stringTime) {
        Date date = null;
